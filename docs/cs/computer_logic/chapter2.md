...
Using Switches 开关电路
  ...
  <div align=center><img src="/assets/img/CS/computer_logic/chapter2/switches.png" width = 70%/></div>
...
??? 半导体
    ...
    **PN 结**
    ...
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/pn.png" width = 40%/></div>
...
??? 三极管
    ...
    **分类**
    ...
    - NPN 型
        ...
        <div align=center><img src="/assets/img/CS/computer_logic/chapter2/npn.png" width = 50%/></div>
    ...
    - PNP 型
        ...
        <div align=center><img src="/assets/img/CS/computer_logic/chapter2/pnp.png" width = 50%/></div>

CMOS Circuits 电压控制

<div align=center><img src="/assets/img/CS/computer_logic/chapter2/cmos.png" width = 20%/></div>

上面 PMOS 管，常闭；下面 NMOS 管，常开。

与非(NAND)和或非(NOR)门（能够构造出所有逻辑关系）

<div align=center><img src="/assets/img/CS/computer_logic/chapter2/nor_nand.png" width = 70%/></div>

输入段可接在一起，输出端不能接在一起，可能短路。

**Logical Gate Symbols**

<div align=center><img src="/assets/img/CS/computer_logic/chapter2/gates.png" width = 70%/></div>

**Waveform Behavior in Time**

<div align=center><img src="/assets/img/CS/computer_logic/chapter2/time_diagram.png" width = 40%/></div>

**Gate Delay**

<div align="center"><img src="/assets/img/CS/computer_logic/chapter2/delay.png" width=50%/></div>
...
<div align="center"><img src="/assets/img/CS/computer_logic/chapter2/algebra.png" width=70%/></div>
...
??? example "Boolean Algebraic Proof 1"
    <div align="center"><img src="/assets/img/CS/computer_logic/chapter2/proof1.png" width=70%/></div>
...
<div align=center><img src="/assets/img/CS/computer_logic/chapter2/terms.png" width = 50%/></div>
...
<div align=center><img src="/assets/img/CS/computer_logic/chapter2/functable.png" width = 70%/></div>
...
!!! example "Cost Criteria"
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/cost.png" width = 70%/></div>
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/cost2.png" width = 70%/></div>
...
<div align=center><img src="/assets/img/CS/computer_logic/chapter2/two_map.png" width = 30%/></div>

!!! example "K-Map Function Representation"
    $F(x,y) = x\bar y + xy$

    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/two_rep.png" width = 30%/></div>

    Then $F(x,y) = x\bar y + xy = x$

#### Three Variable Maps

<div align=center><img src="/assets/img/CS/computer_logic/chapter2/three_map.png" width = 30%/></div>

!!! note
    Topological warps of 3-variable K-maps that show all adjacencies:

    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/cylinder.png" width = 20%/></div>

#### Four Variable Maps

Example Shapes of Rectangles (WXYZ)

<div align=center><img src="/assets/img/CS/computer_logic/chapter2/four_map.png" width = 50%/></div>

#### Five Variable or More K-Maps

For five variable problems, we use two adjacent K-maps.(VWXYZ)

<div align=center><img src="/assets/img/CS/computer_logic/chapter2/five_map.png" width = 50%/></div>
...
!!! example
    ...
    * Find the optimum SOP solution
      <div align=center><img src="/assets/img/CS/computer_logic/chapter2/kmapsop.png" width = 30%/></div>
      $F = AB + \bar BD$
    * Find the optimum POS solution
      <div align=center><img src="/assets/img/CS/computer_logic/chapter2/kmappos.png" width = 30%/></div>
      $F = (B + D)(A + \bar B)$
...
!!! example
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/prime.png" width = 70%/></div>
...
!!! example "Transformation Examples"
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/multi.png" width = 70%/></div>
    最后化为三级门电路，门输入成本降低。
...
<div align=center><img src="/assets/img/CS/computer_logic/chapter2/intcir.png" width = 70%/></div>
...
!!! example "Propagation Delay of `NOT`"
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/tp.png" width = 70%/></div>
...
!!! example
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/delaymodel.png" width = 70%/></div>

#### Circuit Delay

!!! example
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/cirdelay1.png" width = 70%/></div>
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/cirdelay2.png" width = 70%/></div>
    考虑传输延迟，输出波形改变。
...
- XOR implementation
    ...
    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/xor1.png" width = 60%/></div>

    <div align=center><img src="/assets/img/CS/computer_logic/chapter2/xor2.png" width = 60%/></div>
